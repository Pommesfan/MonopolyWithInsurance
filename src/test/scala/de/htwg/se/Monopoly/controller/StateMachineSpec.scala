  ...
  "A Controller has state" when {
    ...
    "roll dice and handleField" should {
      "first player roll three doublets" in {
        controller.players = Vector[Player](playerBaseImpl.Player("player1", 0, 0, 0, 1500, "Cat", Color.BLUE, 3), playerBaseImpl.Player("player2", 1, 0, 0, 1500, "Car", Color.ORANGE))
      ...
      "first player land on visit jail" in {
        controller.players = Vector[Player](playerBaseImpl.Player("player1", 0, 10, 0, 1500, "Cat", Color.BLUE), playerBaseImpl.Player("player2", 1, 0, 0, 1500, "Car", Color.ORANGE))
      ...
      "first player land on free parking" in {
        controller.players = Vector[Player](playerBaseImpl.Player("player1", 0, 20, 0, 1500, "Cat", Color.BLUE), playerBaseImpl.Player("player2", 1, 0, 0, 1500, "Car", Color.ORANGE))
      ...
      "first player land on go to jail" in {
        controller.players = Vector[Player](playerBaseImpl.Player("player1", 0, 30, 0, 1500, "Cat", Color.BLUE), playerBaseImpl.Player("player2", 1, 0, 0, 1500, "Car", Color.ORANGE))
