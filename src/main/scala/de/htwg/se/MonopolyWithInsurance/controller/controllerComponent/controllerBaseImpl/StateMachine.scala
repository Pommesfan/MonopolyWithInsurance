...
import de.htwg.se.MonopolyWithInsurance.controller.{ExitGame, IController}
import de.htwg.se.MonopolyWithInsurance.model.fieldComponent.fieldBaseImpl.{ChanceCard, SpecialField, Street}
