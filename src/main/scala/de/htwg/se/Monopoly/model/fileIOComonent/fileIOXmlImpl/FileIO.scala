package de.htwg.se.Monopoly.model.fileIOComonent.fileIOXmlImpl
...
import de.htwg.se.Monopoly.model.fieldComponent.fieldBaseImpl.{ChanceCard, Field, SpecialField, Street, Tax}
import de.htwg.se.Monopoly.model.fieldComponent.{IField, fieldBaseImpl}
