...
object Variable extends Enumeration {
  ...
  val START_BOARD: Vector[Field] = Vector[Field](
    ...
    ChanceCard(2, "Gemeinschaftsfeld", 0, 0, -1),
    ...
    ChanceCard(7, "Ereignisfeld", 0, 0, -1),
    ...
    ChanceCard(17, "Gemeinschaftsfeld", 0, 0, -1),
    ...
    ChanceCard(22, "Ereignisfeld", 0, 0, -1),
